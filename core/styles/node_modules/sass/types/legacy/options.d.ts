...
export interface LegacySharedOptions<sync extends 'sync' | 'async'> {
   ...
   * sass.renderSync({
   *   file: "style.scss",
   *   includePaths: ["node_modules/bootstrap/dist/styles"]
   * });
   * ```
   *
   ...
   *
   * ```sh
   * $ SASS_PATH=node_modules/bootstrap/dist/styles sass style.scss style.styles
   * ```
   *
   * @category Input
   ...
   * })
   * console.log(result.styles.toString());
   * // h1 {
   * //   font-size: 40px;
   * // }
   * ```
   ...
   * //   font-size: 40px;
   * // }
   * // /*# sourceMappingURL=out.styles.map * /
   * ```
   *
   * @category Source Maps
   */
...
export interface LegacyFileOptions<sync extends 'sync' | 'async'>
   ...
   * as the indented syntax; and if it’s `.styles`, it will be parsed as plain CSS.
   ...
   * extension `.styles`, but contrary to the specification they’re treated as SCSS
